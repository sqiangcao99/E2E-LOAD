...
def construct_optimizer(model, cfg):
    ...
    if cfg.SOLVER.LAYER_DECAY > 0.0 and cfg.SOLVER.LAYER_DECAY < 1.0:
        ...
        lr_coeffs = dict(cfg.SOLVER.LR_COEFF)
        ...
        for (
            ...
            for name_p, p in m.named_parameters(
                ...
                perfix = name.split(".")[0]
                if perfix in lr_coeffs:

                    lr_coeff = lr_coeffs[perfix]
                ...
                elif is_bn:  # there is no bn here;
                    p = {
                        "params": p,
                ...
                else:  # the above are process the spatial layers
                    p = {
                        "params": p,
        ...
        optim_params = non_bn_parameters + zero_parameters + bn_parameters
...
def set_lr(optimizer, new_lr):
    ...
    for (
        ...
        param_group["lr"] = (
            new_lr * param_group["layer_decay"] * param_group["lr_coeff"]
        ) 
